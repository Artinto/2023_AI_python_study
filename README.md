...
#### 📌 AI 프로젝트 (5주)
- 주 1회 진행 `월요일 오후 9시`
- 분야 : __1. NLP__ __2. VISION__
- 분야 선정 및 모델 구성 __tip__
	- 주제 선정 후 task 선택
	- task를 수행할 수 있는 관련 모델 서치
		> colab에서 동작가능한 모델 및 task 선정
	- 모델 구현(모델 가져와서 진행해도 상관없음)
 
- 총 5주간 진행
	- 1주차 `0530`: 주제 선정 및 task, 각 주차별 목표 스케줄 공유 
	- 2주차 `휴강` : 자신의 스케줄에 따른 진행사항 보고
	- 3주차 `0619`: 중간 발표 및 피드백
	- 4주차 `0626`: 자신의 스케줄에 따른 진행사항 보고
	- 5주차 `0703`: 최종 발표
