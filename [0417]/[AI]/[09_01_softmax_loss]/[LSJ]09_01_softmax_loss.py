...
# 1: 0 1 0
# 2: 0 0 1
Y = np.array([1, 0, 0]) #실제 y값 선언
Y_pred1 = np.array([0.7, 0.2, 0.1]) #y 예상값 선언1
Y_pred2 = np.array([0.1, 0.3, 0.6]) #y 예상값 선언2
...
Y = tensor([0], requires_grad=False) #기울기 계산 x
...
l1 = loss(Y_pred1, Y) #오차 1
l2 = loss(Y_pred2, Y) #오차 2
